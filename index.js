// to add and remove new row in the table

$(document).ready(function () {
  $(".add-btn").click(function () {
    $(".item-table-js").append(
      '<tr class="item"> <td "> <div class="two-cells"> <div> <textarea name="" id="" cols="35" rows="3" placeholder="Item Description" ></textarea > </div> <div> <input type="text" placeholder="HSN/ASN" /> </div> </div> </td> <td "> <input type="text" class="cal quantity" value="0" /> </td> <td "> <input type="text" class="cal rate" value="0" /> </td> <td><input type="text" class="cal tax" value="0" /></td> <td "> <input type="text" class="r-tot"  value="0" readonly /> </td> <td> <div><a href= "javascript:void(0)" class="remove-btn">X</a></div> </td> </tr>'
    );
  });
